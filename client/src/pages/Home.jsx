      ...
      <div className='flex-1 px-6 py-20'>
        ...
        <div className='text-center mb-28'>
            ...
            <div className='flex flex-wrap justify-center gap-4 mt-10'>
              ...
              whileHover={{opacity:0.9,scale:1.03}}
              whileTap={{opacity:1,scale:0.98}}
              className='border boredr-gray-300 px-10 py-3 rounded-full hover:bg-gray-100 transition shadow-md'>
                View History
                  ...
                  [
                    ...
                    whileHover={{rotate:0,scale:1.06}}
                     ...
                     className={`
                      ...
                      ${index==2 ? "rotate-[-3deg":""}
                      `}>
                        <div className='absolute -top-8 left-1/2 -translate-x-1/2 bg-white boredr-2 border-green-500 text-green-600 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg'>
                        {item.icon}</div>
                        <div className='pt-10 text-center'>
                          <div className='text-xs text-green-600 font-semibold mb-2 tracking-wider'>{item.step}</div>
                            <h3 className='font-semiboldmb-3 text-lg'>{item.title}</h3>
                ...
                className='text-4xl font-semibold text-center mb-16'>
                  ...
                  <div className='grid md:grid-cols-2 gap-10'>
                    ...
                    whileHover={{scale:1.02}}
                     ...
                     className='bg-white border boredr-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl transtion-all'>
                      <div className='flex flex-col md:flex-row items-center gap-8'>
                        ...
                        <h3 className='font-semibold mb-3 text-xl'>{item.title}
                         ...
                         <p className='text-gray-500 text-sm leading-relaxed'>{item.desc}
                  ...
                  <div className='grid md:grid-cols-2 gap-10'>
                    {
                      [
                        ...
                        },
                        {
                          ...
                          desc:"Deep techincal questioning based on selected role."
                        },
                        {
                          img:confidenceImg,
                          title:"Conifidence Detection",
                    ...
                    whileHover={{y:-6}}
                     ...
                     className='bg-white border border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl transtion-all'>
