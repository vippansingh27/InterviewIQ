...
function Step3Report({report}) {
  ...
  questionWiseScores = [],
   ...
   const questionScoreData = questionWiseScores.map((q, index) => ({
  name: `Q${index + 1}`,
      ...
      const margin = 20;
       ...
       doc.text(`Correctness: ${correctness}`,margin+10,currentY+26);
        ...
        if(finalScore >=8){
          ...
          advice = "Good foundation shown. Improve clarity and structure. Practice delivering concise, confident answers with strong supporting examples.";
        }else{
        ...
        autoTable(doc,{
          ...
          body: questionWiseScores.map((q,i)=>[
            `${i+1}`,
            q.question,
            `${q.score}/10`,
            q.feedback,
            ...
            <div className='space-y-5'>
              {
                skills.map((s,i)=>(
                  <div key={i}>
                    <div className='flex justify-between md-2 text-sm sm:text-base'>
                      <span>{s.label}</span>
