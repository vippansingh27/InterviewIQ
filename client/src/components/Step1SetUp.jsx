...
function Step1SetUp({onStart}) {
  ...
  const handleUploadResume =async()=>{
    ...
    formdate.append("resume",resumeFile)
    try{
      const result = await axios.post(ServerUrl + "/api/interview/resume",formdate,{withCredentials:true})
      ...
      <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        ...
        className='relative bg-gradient-to-br from-green-50 to-green-100 p-12 flex flex-col justify-center'>
          ...
          <p className='text-gray-600 mb-10'>
            ...
            Improve communication ,technical skill, and confidence.
        ...
        className='p-12 bg-white'>
          <h2 className='text-3xl font-bold text-gray-800 mb-8'>
            ...
            <div className='space-y-6'>
              ...
              whileHover={{scale:1.03}}
              whileTap={{scale:0.95}}
              className='w-full disabled:bg-gray-600 bg-green-600 hover:bg-green text-white py-3 rounded-full text-lg font-semibold transition duration-300 shadow-md'>
